	...
	for _, text in ipairs(texts) do
		...
		if matched then
			...
			elseif keyword == "submit" or keyword == "deliver" or keyword == "deposit" or keyword == "exchange" then
				score = score + 4
			elseif keyword == "tower" or keyword == "tsunami" or keyword == "altar" or keyword == "collector" then
				score = score + 3
			end
		end
	end
...
btn.MouseButton1Click:Connect(function()
	...
	if watchMode then
		...
		elseif isTsunamiReadyGateEnabled() and tsunamiSharedState.ready ~= true then
...
mainLoopThread = task.spawn(function()
	while task.wait(0.08) do
		local ok, err = xpcall(function()
			...
			if isTsunamiReadyGateEnabled() and not rewardPickupActive and cooldownRemaining <= 0 and tsunamiSharedState.ready ~= true then
