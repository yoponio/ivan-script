...
local scriptVersion = "phantom-autofarm-r4-no-cell"
...
local depositRetreatOffset = -12
local orbRetreatOffset = -75
...
updateCopyLogsButton()
debugLog("BOOT", string.format("version=%s Ghost Cannon=%s maxDist=%d safeDepth=%d orbRetreat=%d", scriptVersion, safePath(getDepositPrompt()), maxOrbDistance, safeDepth, orbRetreatOffset))
basePos = resolveBasePosition() or basePos
setAutoFarm(true)
